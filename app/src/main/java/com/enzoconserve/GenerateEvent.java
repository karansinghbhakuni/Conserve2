...
public class GenerateEvent extends AppCompatActivity {
    ...
    Button uploadbtn;
    EditText titleet, descet,etime,edate,ephno,eloc,edist;
    ...
    ProgressDialog pd;
    TextView username;
    String date,time,district,phoneno,location;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleet=findViewById(R.id.eventTitle);
        etime=findViewById(R.id.eventtime);
        edate=findViewById(R.id.eventdate);
        ephno=findViewById(R.id.eventphno);
        eloc=findViewById(R.id.EventAddress);
        edist=findViewById(R.id.EventDistrict);
        ...
        uploadbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                location= eloc.getText().toString().trim();
                phoneno= ephno.getText().toString().trim();
                district= edist.getText().toString().trim();
                date= edate.getText().toString().trim();
                time= etime.getText().toString().trim();
                if (TextUtils.isEmpty(date)) {
                    Toast.makeText(GenerateEvent.this, "Enter Date...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(time)) {
                    Toast.makeText(GenerateEvent.this, "Enter Time...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(location)) {
                    Toast.makeText(GenerateEvent.this, "Enter Location...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(district)) {
                    Toast.makeText(GenerateEvent.this, "Enter District...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(phoneno)) {
                    Toast.makeText(GenerateEvent.this, "Enter phoneno...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(title)) {
                    Toast.makeText(GenerateEvent.this, "Enter Title...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(desc)) {
                    Toast.makeText(GenerateEvent.this, "Enter Description...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (image_uri == null) {
                    Toast.makeText(GenerateEvent.this, "Select a Photo...", Toast.LENGTH_SHORT).show();
                    return;
                } else {
                    //post with image
    ...
    private void uploadData(final String title,final String descp, String uri) {
        ...
        ref.putFile(Uri.parse(uri)).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                if (uritask.isSuccessful()) {
                    ...
                    hashMap.put("pTime1",time);
                    hashMap.put("pPhno",phoneno);
                    hashMap.put("pDate",date);
                    hashMap.put("pLoc",location);
                    hashMap.put("pDist",district);
                    ...
                    ref.child(timestamp).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            //adding in database
                            pd.dismiss();
                            Toast.makeText(GenerateEvent.this, "Post Published ...", Toast.LENGTH_SHORT).show();
                            //reset views
                            descet.setText("");
                        ...
                        public void onFailure(@NonNull Exception e) {
                            pd.dismiss();
                            Toast.makeText(GenerateEvent.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
